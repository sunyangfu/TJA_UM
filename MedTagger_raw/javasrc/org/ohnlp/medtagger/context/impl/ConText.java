...
public class ConText {
	...
	{	
		...
		if (regex_PSEUDO.length()>0)
			...
			regexPseudo = Pattern.compile(regex_PSEUDO.substring(1)); //modified by Sunghwan 2015-08-28
...
//			String[] words1=sen.split(" ");
//			String[] words=sentenceTagged.split(" ");
			//---Sunghwan's change 2015-08-31 to avoid incorrect tokenization for more than one space
			String[] words1=sen.split(" +");
			String[] words=sentenceTagged.split(" +");
			//---
