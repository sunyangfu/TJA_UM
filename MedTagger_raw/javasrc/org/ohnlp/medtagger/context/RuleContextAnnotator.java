	...
	public void process(JCas jCas) throws AnalysisEngineProcessException {
		...
		while (sentItr.hasNext()) {
			...
			for (ConceptMention ne : nes) {
				...
				String tagged = conText.preProcessSentence(senPlusOne.toLowerCase()+" ", ne.getCoveredText().toLowerCase());				
				...
				if(tmp.equals(TemporalityContext.Hypothetical.name())) ne.setCertainty("Hypothetical"); //modified by Sunghwan May-18-2015
