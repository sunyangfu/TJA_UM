 ...
 *
 */
public class AsthmaOutputWriter extends CasConsumer_ImplBase {
...
//					String output = docName+"|"+cm.getCoveredText()+"|"+cm.getBegin()+"|"+cm.getEnd()+"|"
//							+cm.getNormTarget();
					String output = docName+"|"+cm.getCoveredText()+"|"+cm.getNormTarget()+"|"+cm.getSentence().getSegment().getId()
							+"|"+cm.getCertainty()+"|"+cm.getStatus()+"|"+cm.getExperiencer();
